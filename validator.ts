...
export namespace Validator{
    ...
    function isSubject(arr:[]):boolean{
        if(Array.isArray(arr)){
    ...
    function isSex(str:string):void{
        if(!isString(str)){
    ...
    export function verify<T extends teacherType | pupilType>(data:T):void{
